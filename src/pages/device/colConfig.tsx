...
export const colDetailConfigs: {
  ...
  [DeviceInfoType.PANEL]: [
    ...
    { title: '版本', dataIndex: 'ver', key: 'ver', isBase: true },
    { title: '运行状态', dataIndex: 'rstate', key: 'rstate' },
    { title: 'ack', dataIndex: 'ack', key: 'ack' },
    { title: 'uuid', dataIndex: 'uuid', key: 'uuid' },
    { title: '错误码', dataIndex: 'err', key: 'err' },
    { title: '工况', dataIndex: 'wstate', key: 'wstate', isBase: true },
    { title: '温度', dataIndex: 'temp', key: 'temp', isBase: true },
    { title: '总重', dataIndex: 'weight', key: 'weight', isBase: true },
  ...
  [DeviceInfoType.READER]: [
    ...
    { title: 'uuid', dataIndex: 'uuid', key: 'uuid' },
    { title: '工况', dataIndex: 'wstate', key: 'wstate', isBase: true },
    { title: '牛号', dataIndex: 'cowid', key: 'cowid', isBase: true },
  ],
